...
public class PaymentRequestStatus implements java.io.Serializable {
    ...
    // Constructor
    protected PaymentRequestStatus(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _NEW = "NEW";
    public static final String _PENDING_REFUND = "PENDING_REFUND";
    ...
    public static final String _REFUNDED = "REFUNDED";
    public static final String _COMPLETED_OVERPAYMENT_REFUND = "COMPLETED_OVERPAYMENT_REFUND";
    public static final String _COMPLETED_OVERPAYMENT_REFUNDED = "COMPLETED_OVERPAYMENT_REFUNDED";
    public static final String _PENDING_APPROVAL = "PENDING_APPROVAL";
    public static final String _PENDING_THIRD_PARTY_CONFIRMATION = "PENDING_THIRD_PARTY_CONFIRMATION";
