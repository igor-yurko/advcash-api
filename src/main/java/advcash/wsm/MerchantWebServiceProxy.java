...
public class MerchantWebServiceProxy implements advcash.wsm.MerchantWebService_PortType {
  ...
  public void validationSendMoneyToAdvcashCard(advcash.wsm.AuthDTO arg0, advcash.wsm.AdvcashCardTransferRequest arg1) throws java.rmi.RemoteException, advcash.wsm.TransactionIsNotAvailableException, advcash.wsm.AccessDeniedException, advcash.wsm.MerchantDisabledException, advcash.wsm.WrongIpException, advcash.wsm.UserBlockedException, advcash.wsm.WrongParamsException, advcash.wsm.LimitPerTransactionException, advcash.wsm.LimitPerMonthException, advcash.wsm.InternalException, advcash.wsm.BadParametersException, advcash.wsm.CardIsNotActiveException, advcash.wsm.LimitPerCardPerDayException, advcash.wsm.TransactionFailureException, advcash.wsm.NotEnoughMoneyException, advcash.wsm.NotAuthException, advcash.wsm.WalletDoesNotExist, advcash.wsm.LifetimeLimitException, advcash.wsm.CardDoesNotExistException, advcash.wsm.DatabaseException, advcash.wsm.LimitPerDayException{
    if (merchantWebService_PortType == null)
      _initMerchantWebServiceProxy();
  ...
  public java.lang.String transferAdvcashCard(advcash.wsm.AuthDTO arg0, advcash.wsm.AdvcashCardTransferRequestDTO arg1) throws java.rmi.RemoteException, advcash.wsm.TransactionIsNotAvailableException, advcash.wsm.AccessDeniedException, advcash.wsm.MerchantDisabledException, advcash.wsm.UserBlockedException, advcash.wsm.WrongIpException, advcash.wsm.UserDoesNotExistException, advcash.wsm.WrongParamsException, advcash.wsm.LimitPerTransactionException, advcash.wsm.LimitPerMonthException, advcash.wsm.BadParametersException, advcash.wsm.CardIsNotActiveException, advcash.wsm.InternalException, advcash.wsm.LimitPerCardPerDayException, advcash.wsm.TransactionFailureException, advcash.wsm.NotEnoughMoneyException, advcash.wsm.LimitsException, advcash.wsm.NotAuthException, advcash.wsm.WalletDoesNotExist, advcash.wsm.LifetimeLimitException, advcash.wsm.CardDoesNotExistException, advcash.wsm.DatabaseException, advcash.wsm.LimitPerDayException{
    if (merchantWebService_PortType == null)
      _initMerchantWebServiceProxy();
